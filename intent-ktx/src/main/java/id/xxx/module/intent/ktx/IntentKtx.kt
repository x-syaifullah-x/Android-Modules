...
inline fun <reified T : Serializable> Intent?.getSerializableExtra(key: String): T? = when {
...
inline fun <reified T : Parcelable> Intent?.getParcelableExtra(key: String): T? = when {
